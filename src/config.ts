...
export const config = {
  ...
  rug_check: {
    ...
    block_symbols: ["XXX"],
    block_names: ["XXX"],
    allow_insider_topholders: true, // Allow inseder accounts to be part of the topholders
    max_alowed_pct_topholders: 100, // Max allowed percentage an individual topholder might hold
